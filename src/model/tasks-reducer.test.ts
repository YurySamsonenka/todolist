...
import { changeTaskStatusAC, changeTaskTitleAC, createTaskAC, createTodolistAC, deleteTaskAC, deleteTodolistAC, tasksReducer } from './tasks-reducer.ts';
...
test('correct task should change its title', () => {
	...
	const endState = tasksReducer(
		startState,
		changeTaskTitleAC({ todolistId: 'todolistId1', taskId: '3', title })
	)
